...
const MojitoPrivacy = () => {
  return (
    <Container pointer={true}>
      <Box>
        <Header>
          <Bigger>모지또</Bigger>개인정보처리방침
        </Header>
        <Contents>
          Team Blender는 개인정보보호법에 따라 이용자의 개인정보 보호 및 권익을
          보호하고 개인정보와 관련한 이용자의 고충을 원활하게 처리할 수 있도록
          다음과 같은 처리방침을 두고 있습니다.
        </Contents>
        <Contents>
          Team Blender는 회사는 개인정보처리방침을 개정하는 경우 웹사이트
          공지사항(또는 개별공지)을 통하여 공지할 것입니다.
        </Contents>
        <Contents>○ 본 방침은부터 2020년 12월 15일부터 시행됩니다.</Contents>
        <Title>1. 개인정보의 처리 목적</Title>
        <Contents>
          Team Blender는 개인정보를 다음의 목적을 위해 처리합니다. 처리한
        ...
        <Title>2. 개인정보 파일 현황</Title>
        <Contents>
          1. 개인정보 파일명 : 모지또개인정보처리방침
          <p>
          ...
          <p>수집방법 : 홈페이지</p>
          <p>보유근거 : 정보 주체의 동의</p>
          <p>보유기간 : 회원 탈퇴 시 지체 없이 파기</p>
          <p>
            관련법령 : 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년, 대금결제
            및 재화 등의 공급에 관한 기록 : 5년, 계약 또는 청약철회 등에 관한
            기록 : 5년
          </p>
        </Contents>
        <Title>3. 개인정보의 처리 및 보유 기간</Title>
        <Contents>
          ① Team Blender는 법령에 따른 개인정보 보유·이용기간 또는
        ...
        <Contents>
          ...
          <p>
            ...
            동의일로부터까지 위 이용목적을 위하여 보유, 이용됩니다.
          </p>
          <p>보유근거 : 정보 주체의 동의</p>
          <p>보유기간 : 회원 탈퇴 시 지체 없이 파기</p>
          <p>관련법령</p>
          <p>1)소비자의 불만 또는 분쟁처리에 관한 기록 : 3년</p>
          <p>2)대금결제 및 재화 등의 공급에 관한 기록 : 5년</p>
          <p>3)계약 또는 청약철회 등에 관한 기록 : 5년</p>
          <Margin></Margin>
          <p>2. 민원사무 처리</p>
          <p>
            민원사무 처리와 관련한 개인정보는 수집.이용에 관한 동의일로부터까지
        ...
        <Contents>
          <p>
            ① 정보주체는 블렌더에 대해 언제든지 개인정보 열람,정정,삭제,처리정지
            요구 등의 권리를 행사할 수 있습니다.
          </p>
          <Margin></Margin>
          <p>
            ② 제1항에 따른 권리 행사는블렌더에 대해 개인정보 보호법 시행령
            제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
            있으며 블렌더은(는) 이에 대해 지체 없이 조치하겠습니다.
          </p>
          <Margin></Margin>
          <p>
          ...
          <Margin></Margin>
          <p>
            ⑥ 블렌더는 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
            처리정지의 요구 시 열람 등 요구를 한 자가 본인이거나 정당한
            대리인인지를 확인합니다.
          </p>
        </Contents>
        <Title>5. 처리하는 개인정보의 항목 작성</Title>
        <Contents>
          ① Team Blender는 다음의 개인정보 항목을 처리하고 있습니다.
          <Margin></Margin>
          <p>홈페이지 회원가입 및 관리</p>
          <p>
        ...
        <Title>6. 개인정보의 파기</Title>
        <Contents>
          Team Blender는 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이
        ...
        <Contents>
          ① 블렌더 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고
        ...
        <Title>8. 개인정보 보호책임자 작성 </Title>
        <Contents>
          ① 블렌더는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
          ...
          <p>직책 :CTO</p>
          <p>직급 :BE Dev 리더</p>
          <p>연락처 :01056631891, blender.cowork@gmail.com</p>
          ...
          <Margin></Margin>
          <p>
            ② 정보주체께서는 블렌더의 서비스(또는 사업)을 이용하시면서 발생한
            모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
            개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 블렌더는
            정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.
          </p>
        </Contents>
        <Title>9. 개인정보 처리방침 변경 </Title>
        <Contents>
        ...
        <Title>
          10. 개인정보의 안전성 확보 조치 Team Blender는 개인정보보호법 제29조에
        ...
        <Contents>
          ...
          <p>
            블렌더는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보 유출 및 훼손을
